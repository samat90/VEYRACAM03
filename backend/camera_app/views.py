...
def _build_summary(session_id):
    ...
    return {
        ...
        'avg_posture_angle': round(agg['avg_angle'], 1) if agg['avg_angle'] else None,
        'avg_blink_rate': round(agg['avg_blink'], 1) if agg['avg_blink'] else None,
        'avg_perclos': round(agg['avg_perclos'], 1) if agg['avg_perclos'] else None,
        'avg_breath_rate': round(agg['avg_breath'], 1) if agg['avg_breath'] else None,
